    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-inspinia text-primary" id="exampleModalLabel">Eliminar Categoría</h5>
            ...
            @foreach($Categorias as $Categorias)
                <form action="{{url('/categorias/'.$Categorias->id)}}" role="form" method="POST" id="deleteCategoriaFrm" enctype="multipart/form-data">
                @method('DELETE')
                    {{csrf_field()}}
                    @endforeach
                    <div class="row">
