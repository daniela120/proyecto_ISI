                ...
                <table id="dt-usuario" class="table table-stripped table-bordered dts">
                    <thead>
                        ...
                        <th class="text-center">Id </th>
                            <th class="text-center"><font size=2>Nombre Compañia</th>                      
                            <th class="text-center"><font size=2>Nombre Contacto</th>  
                            <th class="text-center"><font size=2>Teléfono</th>  
                            <th class="text-center"><font size=2>Sitio Web</th>  
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><font size=2>{{$Proveedores->id}}</td>
                            <td><font size=2>{{$Proveedores->NombreCompania}}</td>
                            <td><font size=2>{{$Proveedores->NombreContacto}}</td> 
                            <td><font size=2>{{$Proveedores->Telefono}}</td> 
                            <td><font size=2>{{$Proveedores->SitioWeb}}</td>   
                            <td><font size=2>{{$Proveedores->Direccion}}</td>      
