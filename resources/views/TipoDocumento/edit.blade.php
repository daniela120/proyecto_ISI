...
<div class="modal animated zoomIn" id="editMdl" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-inspinia text-primary" id="exampleModalLabel">Editar Tipo de Documento</h5>
    ...
    <form action="{{ url('/documentos/.$tipodocumentos->id') }}" method="post" id="editTipoDocumentoForm" enctype="multipart/form-data">
