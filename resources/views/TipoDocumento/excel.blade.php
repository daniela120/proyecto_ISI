...
<thead>
                    <tr>
                        <th style="background-color:#A9D0F5"></th>
                        <th style="background-color:#A9D0F5"></th>
                        <th class="text-center" style="background-color:#A9D0F5"><b><h4>TIPO DOCUMENTOS</h4></b> </th>
                        <th style="background-color:#A9D0F5"></th>
                        <th style="background-color:#A9D0F5"></th>
                    ...
                    @foreach($tipodocumentos as $tipodocumentos)
                        <tr>
                                ...
                                <td style="background-color:#ffffff">{{$tipodocumentos->TipoDocumento}}</td> 
                                <td style="background-color:#ffffff">{{$tipodocumentos->Descripcion}}</td> 
                                <td style="background-color:#ffffff">{{$tipodocumentos->id}}</td>
                                <td style="background-color:#ffffff"></td>
                        </tr>
                        @endforeach
                    </tbody>
