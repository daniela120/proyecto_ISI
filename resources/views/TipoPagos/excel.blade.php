...
<thead>
                    <tr>
                        <th style="background-color:#A9D0F5"></th>
                        <th style="background-color:#A9D0F5"></th>
                        <th class="text-center" style="background-color:#A9D0F5"><b><h4>TIPOS DE PAGO</h4></b> </th>
                        <th style="background-color:#A9D0F5"></th>
                        <th style="background-color:#A9D0F5"></th>
                    </tr>
                    <tr>
                            ...
                            <th class="text-center" style="background-color:#ffe599">Nombre Pago</th>
                    ...
                    @foreach($tipopagos as $Des)
                        <tr>
                                 <td style="background-color:#ffffff"></td>
                                 <td style="background-color:#ffffff">{{$Des->Nombre_Tipo_Pago}}</td>
