    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" role="form" method="POST" id="deleteUserFrm" enctype="multipart/form-data">
                @method('DELETE')
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <div>
                                <label for="User" class="form-fields"> ¿Esta seguro de eliminar este Usuario?</label>
                            </div>
                        </div>
                    </div>
