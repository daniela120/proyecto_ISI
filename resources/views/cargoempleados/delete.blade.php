    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            @foreach($cargoempleados as $cargoempleados)
                <form action="{{url('/cargoempleados/'.$cargoempleados->id)}} " role="form" method="POST" id="deleteCargoempleadoFrm" enctype="multipart/form-data">
                @method('DELETE')
                    {{csrf_field()}}
                    @endforeach
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <div>
                                <label for="Cargoempleados" class="form-fields"> ¿Esta seguro de eliminar el cargo?</label>
                            </div>
                        </div>
                    </div>
