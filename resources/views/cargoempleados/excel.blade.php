...
<thead>
                    ...
                    @foreach($cargoempleados as $cargoempleados)
                        <tr>
                            <td style="background-color:#ffffff">{{$cargoempleados->id}}</td>
                            <td style="background-color:#ffffff">{{$cargoempleados->Cargo}}</td>
                            <td style="background-color:#ffffff">{{$cargoempleados->Salario}}</td>
                            <td style="background-color:#ffffff">{{$cargoempleados->Descripcion}}</td>
