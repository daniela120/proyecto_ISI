...
<thead>
                    <tr>
                        <th style="background-color:#A9D0F5"></th>
                        <th style="background-color:#A9D0F5"></th>
                        <th class="text-center" style="background-color:#A9D0F5"><b><h4>PRECIO INVENTARIO</h4></b> </th>
                        <th style="background-color:#A9D0F5"></th>
                        <th style="background-color:#A9D0F5"></th>
                    ...
                    <tr>
                            ...
                            <th class="text-center" style="background-color:#ffe599">Inventario</th>
                    ...
                    @foreach($preciosinventario as $precioinventario)
                        <tr>
                            <td style="background-color:#ffffff">{{$precioinventario->id}}</td>
                            <td style="background-color:#ffffff">{{$precioinventario->NombreInventario}}</td>
                            <td style="background-color:#ffffff">{{$precioinventario->Precio}}</td>     
                            <td style="background-color:#ffffff">{{$precioinventario->FechaInicio}}</td>
                            <td style="background-color:#ffffff">{{$precioinventario->FechaFinal}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
